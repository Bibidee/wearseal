...
export async function readVault(address:`0x${string}`){return publicClient.readContract({address,functionName:'get_vault',args:[]}) as Promise<{agreement:string;credited:bigint;settled:boolean}>}
